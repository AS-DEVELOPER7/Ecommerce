...
{image?.map((item,i)=>(
    ...
    <div className="product-detail-desc">
        <h1 className='font-bold text-[2em]'>{name}</h1>
...
export const getStaticPaths = async () => {
  // get the current slug value of all the products
...
export const getStaticProps = async ({ params: { slug } }) => {
  // get all the products whos slug value is equal to our url slug value
